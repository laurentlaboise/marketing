...
function emailShell(title, bodyHtml) {
  ...
  <div style="max-width:520px;margin:24px auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
    <div style="background:#122a3f;padding:18px 24px;">
      <span style="color:#ffffff;font-size:1.05rem;font-weight:bold;">Words That Sells</span>
    </div>
    ...
    <div style="padding:14px 24px;border-top:1px solid #e2e8f0;color:#94a3b8;font-size:0.78rem;">
      Words That Sells — wordsthatsells.website
    </div>
  </div>
</body></html>`;
}
...
async function sendMagicLink(to, link) {
  return sendEmail({
    to,
    subject: 'Your sign-in link — Words That Sells',
    html: emailShell('Sign in to your account', `
      <p style="color:#334155;font-size:0.95rem;line-height:1.6;">Click the button below to sign in. The link works once and expires in 15 minutes.</p>
      <p style="text-align:center;margin:24px 0;">
        <a href="${link}" style="background:#d62b83;color:#ffffff;text-decoration:none;padding:12px 28px;border-radius:8px;font-weight:bold;display:inline-block;">Sign in</a>
      </p>
      <p style="color:#94a3b8;font-size:0.8rem;line-height:1.5;">If the button doesn't work, copy this address into your browser:<br>${link}</p>
      <p style="color:#94a3b8;font-size:0.8rem;">Didn't request this? You can safely ignore this email.</p>
    `),
    text: `Sign in to Words That Sells: ${link}\nThe link works once and expires in 15 minutes.`
  });
}
