...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent =
      ...
      'justify-content:space-between;align-items:center;background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:#fff;}' +
      ...
      '.help-sidebar-body a{color:#667eea;text-decoration:underline;}' +
