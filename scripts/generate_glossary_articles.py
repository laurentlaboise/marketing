...
.cta{margin:48px 0;padding:32px 28px;background:#d62b83;color:#ffffff;border-radius:14px;text-align:center;box-shadow:0 10px 24px rgba(214,43,131,.35);font-weight:600;text-shadow:0 1px 2px rgba(0,0,0,.25)}
.cta p{color:#ffffff;text-shadow:0 1px 2px rgba(0,0,0,.25)}
.cta a{color:#ffffff;font-weight:700;text-decoration:underline;text-underline-offset:3px;text-shadow:0 1px 2px rgba(0,0,0,.25)}
.cta a:hover{color:#ffffff;opacity:1;filter:brightness(1.08)}
